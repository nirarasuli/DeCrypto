  ...
  return (
    <ThemeProvider theme={darkTheme}>
      <Container style={{ textAlign: "center" }}>
        <Typography
          variant="h4"
          style={{ margin: 18, fontFamily: "Plus Jakarta Sans" }}
        >
        ...
        <TableContainer component={Paper}>
          {loading ? (
            <LinearProgress style={{ backgroundColor: "#E8CF7D" }} />
          ) : (
            <Table aria-label="simple table">
              <TableHead style={{ backgroundColor: "#E8CF7D" }}>
                <TableRow>
